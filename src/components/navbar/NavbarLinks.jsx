...
const NavbarLinks = () => {
  ...
  const links = [
    { link: t('navLinks.about'), section: "about" },
    { link: t('navLinks.skills'), section: "skills" },
    { link: t('navLinks.experience'), section: "experience" },
    { link: t('navLinks.projects'), section: "projects" },
    { link: t('navLinks.contact'), section: "contact" },
  ];
