...
const SingleProject = ({ name, techStack, align, image, desc }) => {
  return (
    <motion.div
    ...
    >
      <div>
        ...
        <div
          className={`text-md font-bold text-lightCyan/80 font-special sm:text-center md:text-left
          }`}
        >
          {techStack}
        </div>
        <div className="text-md font-bold text-white/90 font-special sm:text-center md:text-left mt-2">
          {desc}
        </div>
